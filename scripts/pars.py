...
class ModelParameters:
    """
        ...
        Inputs:
            ...
            confined: flaag whether model is confined (boolean)
    ...
    def __init__(self, name="none", Lx=800, Ly=400, Lz=25, confined=True, offshore_proportion=None, 
                sea_level=None, ncol=80, nrow=40, nlay=50, K=10, anis=1, sy=0.24, 
                ss=1e-5, n=0.3, alpha_L=4, alpha_anisT=0.1, alpha_anisV=0.01, 
                diff=8.64e-5, perlen=1e9, dt=1e6, h_b=1, W_net=None, sconc=0,
